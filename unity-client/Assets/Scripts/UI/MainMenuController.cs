...
namespace AppreciatorsTcg.UI
{
    public class MainMenuController : ScreenControllerBase
    {
        private void Start()
        {
            ...
            UIFactory.CreateButton(panel.transform, "Invite 1v1", () => SceneManager.LoadScene("InviteMatchScene"), UIFactory.Accent);
            ...
            UIFactory.CreateButton(panel.transform, "Wallet / Web3", () => SceneManager.LoadScene("Web3MockScene"), UIFactory.Blue);
        }
